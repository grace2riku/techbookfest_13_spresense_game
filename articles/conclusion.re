...
この方法を使えばシェルからコマンドを実行しなくてもよい電源ONでスタンドアロンで動作するアプリケーションがつくれそうです。
 ...
 * 読みにくい、読めない
 * 処理のまとまりが画面に収まっていないので動作が追えない

今回とりあえず動作することを第一にサンプルプログラムを流用させていただき、ゲーム機能を追加実装しました。

可読性、変更しやすさなどが考慮できませんでした。この辺はリファクタリングで改善していければ・・・と考えています。
